---
title: "第 8 章 实例二：ShuTongBuddy Studio（Web 备考助手）"
description: "终章实例把前七章攒成一件完整作品：一个 Web 端的大学生备考助手 ShuTongBuddy Studio。前端跑在浏览器里，界面布局参考 Codex 风格；后端用 FastAPI 编排，智能体引擎就是 DeepSeek……"
---
