---
title: "Preface"
description: "Why this book was written: turning DeepSeek Harness from an idea into a working agent application, with the ShuTongBuddy exam-prep assistant as the running case."
---

Picture a first-year student facing a brand-new course: textbooks, lecture notes, past exam papers and mistake logs scattered across different folders. They do not know where to start, and they cannot tell which topics they are actually weak in. This is the real predicament of countless learners — and agents offer a new way out: a study companion that understands you and prepares alongside you.
